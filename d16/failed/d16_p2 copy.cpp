...
int main()
{
    ...
    while(!pq.empty())
    {
        ...
        if (dist[curr_row][curr_col][modulo(curr_direction + 1, 4)] > curr_weight + 1000) dist[curr_row][curr_col][modulo(curr_direction + 1, 4)] = curr_weight + 1000;
        if (dist[curr_row][curr_col][modulo(curr_direction - 1, 4)] > curr_weight + 1000) dist[curr_row][curr_col][modulo(curr_direction - 1, 4)] = curr_weight + 1000;
    ...
    while(!pq2.empty())
    {
        ...
        // Rotating around the same cell
       

        if (dist2[curr_row][curr_col][modulo(curr_direction + 1, 4)] > curr_weight + 1000) dist2[curr_row][curr_col][modulo(curr_direction + 1, 4)] = curr_weight + 1000;
        if (dist2[curr_row][curr_col][modulo(curr_direction - 1, 4)] > curr_weight + 1000) dist2[curr_row][curr_col][modulo(curr_direction - 1, 4)] = curr_weight + 1000;
    ...
    for(int i = 0; i < matrix.size(); i++)
    {
        for(int j = 0; j < matrix[0].size(); j++)
        {
            ...
            // if (dists_from_start[0] + dists_from_end[2] == best_path_weight) ans.insert(make_pair(i,j));
            // if (dists_from_start[2] + dists_from_end[0] == best_path_weight) ans.insert(make_pair(i,j));
            // if (dists_from_start[1] + dists_from_end[3] == best_path_weight) ans.insert(make_pair(i,j));
            // if (dists_from_start[3] + dists_from_end[1] == best_path_weight) ans.insert(make_pair(i,j));
